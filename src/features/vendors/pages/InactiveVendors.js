...
const InactiveVendors = (props) => {
    ...
    const inactiveVendorsData = typeSelection?.body;
    const vendorListType = props?.type;
    console.log(inactiveVendorsData, "datataaaaaa")
                ...
                <div className='table-responsive mt-4'>
                    <Table className='b-table b-tablefirsttd'>
                        ...
                        <tbody>{isLoading ? (
                          ...
                          <>
                            {inactiveVendorsData && Array.isArray(inactiveVendorsData) && inactiveVendorsData?.map((vendor, index) => (
                                <tr key={index} onClick={(e) => handleTableRowClick(e, vendor)}>
                                    ...
                                    {/* <td>{vendorListType !== "Partners" ? vendor.vendor_type : vendor?.partner_type}</td> */}
                            ...
                            {(!inactiveVendorsData || inactiveVendorsData.length === 0) && (
                                <tr>
